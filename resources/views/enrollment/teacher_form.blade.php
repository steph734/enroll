                    ...
                    <div class="row">
                        ...
                        <div class="p-1 mb-3 col-md-4">
                            ...
                            <input type="number" class="form-control @error('age') is-invalid @enderror" id="age"
                                name="age" min="1" value="{{ old('age') }}" required>
                            @error('age')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="m-3 row">
                ...
                <div class="p-1 mb-3 col-md-3">
                    ...
                    <input type="text" class="form-control @error('year_graduated') is-invalid @enderror"
                        id="year_graduated" name="year_graduated" value="{{ old('year_graduated') }}" required>
        ...
        <div class="mb-3 shadow-sm  card form-section">
            <div class="m-3 row">
                <div class="p-1 mb-3 col-md-4">
                    ...
                    <input type="text" class="form-control @error('prc_license') is-invalid @enderror" id="prc_license"
                        name="prc_license" value="{{ old('prc_license') }}" required>
                    @error('prc_license')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="p-1 mb-3 col-md-4">
                    ...
                    <input type="date" class="form-control @error('license_validity') is-invalid @enderror"
                        id="license_validity" name="license_validity" value="{{ old('license_validity') }}" required>
                ...
                <div class="p-1 mb-3 col-md-4">
                    ...
                    <input type="date" class="form-control @error('let_date') is-invalid @enderror" id="let_date"
                        name="let_date" value="{{ old('let_date') }}" required>
                    @error('let_date')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="m-3 row">
                ...
                <div class="p-1 mb-3 col-md-6">
                    ...
                    <input type="file" class="form-control @error('prc_copy') is-invalid @enderror" id="prc_copy"
                        name="prc_copy" accept=".pdf,.jpg,.png" required>
                    @error('prc_copy')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="mb-3 shadow-sm  card form-section">
            <div class="m-3 row">
                ...
                <div class="p-1 mb-3 col-md-4">
                    ...
                    <input type="number" class="form-control @error('years_experience') is-invalid @enderror"
                        id="years_experience" name="years_experience" min="0" value="{{ old('years_experience') }}">
            ...
            <div class="m-3 row">
                <div class="p-1 mb-3 col-md-4">
                    ...
                    <select class="form-select @error('employment_status') is-invalid @enderror" id="employment_status"
                        name="employment_status" required>
                        <option value="">Select</option>
                        <option value="Full-time" {{ old('employment_status') == 'Full-time' ? 'selected' : '' }}>
                            Full-time</option>
                        <option value="Part-time" {{ old('employment_status') == 'Part-time' ? 'selected' : '' }}>
                            Part-time</option>
                    </select>
                ...
                <div class="p-1 mb-3 col-md-4">
                    ...
                    <select class="form-select @error('teaching_schedule') is-invalid @enderror" id="teaching_schedule"
                        name="teaching_schedule" required>
                        <option value="">Select</option>
                        <option value="Morning" {{ old('teaching_schedule') == 'Morning' ? 'selected' : '' }}>Morning
                        </option>
                        <option value="Afternoon" {{ old('teaching_schedule') == 'Afternoon' ? 'selected' : '' }}>
                            Afternoon</option>
                        <option value="Evening" {{ old('teaching_schedule') == 'Evening' ? 'selected' : '' }}>Evening
                        </option>
                    </select>
                ...
                <div class="p-1 mb-3 col-md-4">
                    ...
                    <input type="text" class="form-control @error('subjects') is-invalid @enderror" id="subjects"
                        name="subjects" value="{{ old('subjects') }}" required>
                    @error('subjects')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="mb-3 shadow-sm  card form-section">
            <div class="p-3 row">
                <div class="p-1 mb-3 col-md-4">
                    ...
                    <textarea class="form-control @error('certifications') is-invalid @enderror" id="certifications"
                        name="certifications" rows="3">{{ old('certifications') }}</textarea>
                ...
                <div class="p-1 mb-3 col-md-4">
                    ...
                    <textarea class="form-control @error('accommodations') is-invalid @enderror" id="accommodations"
                        name="accommodations" rows="3">{{ old('accommodations') }}</textarea>
            ...
            <div class="m-3 row">
                ...
                <div class="p-1 mb-3 col-md-6">
                    ...
                    <input type="file" class="form-control @error('transcript') is-invalid @enderror" id="transcript"
                        name="transcript" accept=".pdf,.doc,.docx" required>
                    @error('transcript')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="mb-3 shadow-sm card form-section">
            <div class="m-3 row">
                <div class="p-1 mb-3 col-md-6">
                    ...
                    <input type="date" class="form-control @error('date_hired') is-invalid @enderror" id="date_hired"
                        name="date_hired" value="{{ old('date_hired') }}" required>
                    @error('date_hired')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
