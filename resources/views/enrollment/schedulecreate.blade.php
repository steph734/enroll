...
<div class="schedule-content">
    <div class="card p-3">
        <div class="d-flex justify-content-between mb-3">
            <div>
                ...
                <p style="font-size:14px; color:#555 !important;">
                    Easily add a new class schedule. Enter the subject details, timing, and strand to organize your
        ...
        <form action="{{ route('schedule.store') }}" method="POST" class="mt-4" id="scheduleForm">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="autocomplete-container">
                            ...
                            <div class="autocomplete-suggestions" id="sectionSuggestions">
                                ...
                                <div class="suggestion-item" data-value="{{ $section->section_name }}">
                                    ...
                                    {{ $section->section_name }} ({{ $section->strand->strand_name }})
                                </div>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="day-checkboxes">
                            ...
                            <div class="form-check">
                                <input class="form-check-input day-checkbox" type="checkbox" value="{{ $abbr }}"
                                    id="{{ $day }}" {{ in_array($abbr, str_split(old('days', ''))) ? 'checked' : '' }}>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-control p-1" id="term" name="term"
                            ...
                            <option value="1st Term" {{ old('term') === '1st Term' ? 'selected' : '' }}>1st Term
                            </option>
                            <option value="2nd Term" {{ old('term') === '2nd Term' ? 'selected' : '' }}>2nd Term
                            </option>
                            <option value="3rd Term" {{ old('term') === '3rd Term' ? 'selected' : '' }}>3rd Term
                            </option>
                            <option value="4th Term" {{ old('term') === '4th Term' ? 'selected' : '' }}>4th Term
                            </option>
                        </select>
                        @error('term')
                        <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="dropdown">
                            <a class="btn btn-outline-dark p-1 btn-sm" href="#" role="button" data-bs-toggle="dropdown"
                                ...
                                <i class="fa-solid fa-clock"></i> <span class="time-label">Select a Time</span>
                            </a>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control p-1" id="room" name="room" value="{{ old('room') }}"
                            class="@error('room') is-invalid @enderror" required>
                        @error('room')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
